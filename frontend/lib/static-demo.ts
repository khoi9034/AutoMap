...
export const staticDemoComposerResponse: ComposerResponse = {
  ...
  warnings: [
    "Static demo fallback. Live backend unavailable.",
  ...
  map_layout: {
    ...
    subtitle: "Static demo fallback. Live backend unavailable.",
  ...
  preview_config: {
    ...
    can_focus_map: true,
    preview_only: true,
    warnings: ["Static demo fallback. Live backend unavailable."],
    derived_overlays: [],
  },
  composer_timing: {
    total_ms: 0,
