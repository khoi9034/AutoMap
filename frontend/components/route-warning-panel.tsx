  ...
  return (
    <section className="notice notice-warning">
      <div className="panel-title-row">
        ...
        <StatusChip tone="warning">{routeStatus || "straight_line_fallback"}</StatusChip>
      </div>
      <p>
        AutoMap prefers a bounded road-following draft when verified street centerlines can be queried safely. Otherwise
        it shows a straight-line fallback and does not call paid or external routing APIs.
      </p>
      {warnings.length ? (
