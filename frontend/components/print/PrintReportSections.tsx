...
import { PrintLayerTableSection } from "@/components/print-preview/print-layer-table-section";
import { PrintSourceNotesSection } from "@/components/print-preview/print-source-notes-section";
import { PrintStatisticsSection } from "@/components/print-preview/print-statistics-section";
import { PrintSummarySection } from "@/components/print-preview/print-summary-section";
import { PrintWarningSection } from "@/components/print-preview/print-warning-section";

type PrintReportSectionsProps = {
...
export function PrintReportSections({ mapState, printOptions, response }: PrintReportSectionsProps) {
  const isMapSheet = printOptions.exportMode === "map_sheet";
  if (isMapSheet) return null;
  return (
    <>
      ...
      {printOptions.includeProximitySummary ? <PrintSummarySection title="Proximity Summary" items={proximityItems(response, mapState)} /> : null}
